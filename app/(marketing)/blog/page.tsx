        ...
        <div className="container px-4 mx-auto max-w-6xl">
          <div className="max-w-3xl mx-auto text-center">
            <div className="bg-white/40 backdrop-blur-md rounded-3xl border border-white/30 p-12 md:p-16 shadow-lg">
              <div className="w-20 h-20 bg-gradient-to-br from-emerald-600 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-8">
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                We're working on valuable content for you. In the meantime, check out our documentation and tutorials to get the most out of Velocity.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            {[
              ...
              },
              {
                ...
                description: 'Deep dives into how Velocity works'
              }
            ].map((resource, index) => (
