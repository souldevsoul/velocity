        ...
        <div className="container px-4 mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {[
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-teal-600 to-emerald-700 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              <div className="space-y-4 text-gray-600">
                <div>
                  ...
                  <a href="mailto:support@velocitydev.com" className="text-teal-600 hover:underline">
