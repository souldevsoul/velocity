          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="bg-white/40 backdrop-blur-md rounded-3xl border border-white/30 p-8">
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Velocity helps developers ship faster by automating repetitive development tasks. Built by experienced developers who understand the pain of rebuilding authentication, databases, and deployment pipelines for every project.
                </p>
                <p>
                  We've been there - setting up the same boilerplate code, configuring the same tools, solving the same problems over and over. That's why we built Velocity.
                </p>
                <p>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {[
              ...
              <div key={index} className="text-center bg-white/40 backdrop-blur-md rounded-3xl border border-white/30 p-8">
                <div className="text-5xl md:text-6xl font-bold bg-gradient-to-br from-emerald-600 to-teal-500 bg-clip-text text-transparent mb-4">
                  {stat.number}
                </div>
