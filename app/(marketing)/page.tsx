...
export default function HomePage() {
  const seoData = {
    description: 'Velocity is an AI-powered development platform that helps you build and deploy production-ready applications in hours, not months.',
        ...
        <div className="container px-4 mx-auto relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="font-heading tracking-tighter text-6xl sm:text-7xl lg:text-8xl font-black mb-8 leading-tight pt-16">
              ...
              <span className="block bg-gradient-to-r from-emerald-600 via-green-700 to-green-800 bg-clip-text text-transparent">
                Scale Smarter
              </span>
              <span className="block text-gray-900">Build in Hours, Not Months</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-16">
              <Link href="/login">
                <Button type="button" className="group relative overflow-hidden bg-gradient-to-r from-teal-500 via-emerald-600 to-green-700 hover:from-teal-600 hover:via-emerald-700 hover:to-green-800 text-white font-black text-xl px-14 py-8 rounded-xl shadow-[0_20px_50px_rgba(16,185,129,0.5)] hover:shadow-[0_20px_60px_rgba(16,185,129,0.7)] transform hover:scale-105 hover:-translate-y-1 transition-all duration-300 border border-emerald-400/50">
        ...
        <div className="container mx-auto px-4">
          <div className="relative bg-white/40 backdrop-blur-md rounded-3xl p-12 border border-white/30">
            ...
            <div className="text-center group">
              <div className="text-5xl md:text-6xl font-black text-gray-900 mb-3 group-hover:text-emerald-700 transition-colors">
                10hrs
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto bg-white/40 backdrop-blur-md rounded-3xl p-12 border border-white/30">
            <div className="text-center mb-20">
              <p className="text-emerald-600 font-bold text-sm uppercase tracking-wider mb-4">Features</p>
              <h2 className="text-5xl md:text-6xl font-black text-gray-900 mb-6">
                Everything you need <span className="text-emerald-600">to ship faster</span>
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={idx} className="group p-8 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:border-teal-400/50 hover:bg-white/10 transition-all duration-300">
                  <div className="w-16 h-16 bg-gradient-to-br from-teal-400 to-emerald-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center bg-white/40 backdrop-blur-md rounded-3xl p-16 border border-white/30">
            <h2 className="text-5xl md:text-7xl font-black text-gray-900 mb-6">
              Ready to build your <span className="text-emerald-600">next project?</span>
            </h2>
            ...
            <Link href="/login">
              <Button type="button" className="group relative overflow-hidden bg-white hover:bg-gray-100 text-emerald-600 font-black text-2xl px-16 py-10 rounded-2xl shadow-[0_30px_60px_rgba(255,255,255,0.3)] hover:shadow-[0_30px_80px_rgba(255,255,255,0.4)] transform hover:scale-105 transition-all duration-300">
                <div className="absolute inset-0 bg-gradient-to-r from-teal-500/0 via-teal-500/20 to-teal-500/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-700"></div>
