      ...
      <section className="relative py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center bg-white/40 backdrop-blur-md rounded-3xl p-16 border border-white/30">
            ...
            <Link href="/login">
              <Button className="group relative overflow-hidden bg-white hover:bg-gray-100 text-emerald-600 font-black text-2xl px-16 py-10 rounded-2xl shadow-[0_30px_60px_rgba(255,255,255,0.3)] hover:shadow-[0_30px_80px_rgba(255,255,255,0.4)] transform hover:scale-105 transition-all duration-300">
