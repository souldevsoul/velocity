              ...
              <div key={index} className="relative">
                {pkg.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-br from-emerald-600 to-green-700 rounded-full shadow-lg">
                      <Sparkles className="w-4 h-4 text-white" />
                      <span className="text-white uppercase text-xs font-semibold">RECOMMENDED</span>
                    </div>
                  </div>
                )}
                <div className={`rounded-2xl border ${pkg.popular ? 'border-emerald-600 shadow-2xl scale-105' : 'border-gray-200 shadow-lg'} bg-white/40 backdrop-blur-md border-white/30 p-8 h-full flex flex-col`}>
