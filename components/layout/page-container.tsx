...
const PageContainer: React.FC<PageContainerProps> = ({
  ...
  return (
    <div className="antialiased text-body font-body min-h-screen flex flex-col">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-emerald-600 text-white px-4 py-2 rounded-lg z-50 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
      >
