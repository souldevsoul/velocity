              ...
              <div className="flex flex-wrap items-center -mx-4">
                ...
                <div className="w-full lg:w-1/3 px-4">
                  <div className="flex items-center justify-end">
                    <a className="inline-flex mr-6 text-gray-400 hover:text-emerald-700 items-center justify-center transition duration-200" href="#">
                    ...
                    <a className="inline-flex text-gray-400 hover:text-emerald-700 items-center justify-center transition duration-200" href="#">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
