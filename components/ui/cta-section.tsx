  ...
  return (
    <section className={`py-12 md:py-24 ${className}`}>
      <div className="container px-4 mx-auto">
        <div className="relative pb-16 border-b border-emerald-400 overflow-hidden">
          {/* Background Images */}
          <Image
          ...
          <div className="relative max-w-sm md:max-w-xl mx-auto text-center">
            {badge && (
              <span className="inline-flex items-center h-6 mb-4 px-2 text-sm font-medium text-emerald-700 bg-emerald-200 rounded-full">
                {badge}
              </span>
            )}
