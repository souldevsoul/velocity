...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(({
  ...
  const variantClasses = {
    ...
    secondary: 'text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 hover:border-emerald-600 focus:ring-emerald-500 shadow-sm hover:shadow-none rounded-lg',
    outline: 'text-emerald-700 bg-transparent border border-emerald-600 hover:bg-emerald-50 focus:ring-emerald-500 rounded-lg',
