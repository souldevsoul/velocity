      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-9 h-9 bg-gradient-to-br from-emerald-600 to-green-700 rounded-lg flex items-center justify-center transition-transform hover:scale-105">
            ...
            <span className="text-lg font-semibold text-white">Velocity</span>
          </Link>
