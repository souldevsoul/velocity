        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 lg:w-5/12 px-4 mb-20 lg:mb-0">
            <div className="max-w-xs mb-10">
              <span className="inline-flex items-center h-6 mb-4 px-2 text-sm uppercase font-medium text-emerald-700 bg-emerald-200 rounded-full">Feature</span>
            ...
            <a className="xs:flex-shrink-0 group relative w-full xs:w-auto h-12 flex xs:inline-flex items-center justify-center px-5 font-bold text-gray-700 bg-white border border-gray-200 hover:border-emerald-600 shadow-md hover:shadow-none rounded-lg transition-all duration-300 focus:outline-none" href="#">
