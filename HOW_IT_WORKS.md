# How Velocity Works - Complete End-to-End Guide

## Platform Overview

Velocity is an AI-powered MVP development platform with a credit-based system and expert task assignment workflow. Users can generate MVPs with AI and assign specific tasks to human experts for implementation.
...
1. **Landing Page** (`/`)
   - User visits https://velocity-ias5fnypp-soultosoul.vercel.app
   - Sees hero: "Ship Faster, Scale Smarter"
...
**Platform**: Velocity MVP Development Platform
