# Velocity - Complete Project Setup Checklist
...
**Project:** Velocity (AI-powered MVP Development Platform)
**Status:** ⏳ In Progress
...
- [ ] Shows brand colors (Emerald/Green, NOT yellow)
...
**Location:** `/Users/rentamac/Documents/repos/repos/batch-2/velocity/.claude/commands/onboard.md`
...
**Purpose:** Align pages to Velocity design system

**Requirements:**
- [ ] References Velocity colors (Emerald/Green)
...
**Location:** `/Users/rentamac/Documents/repos/repos/batch-2/velocity/.claude/PRODUCT_SPEC.md`
...
**Key Sections:**
1. Brand Colors (Emerald/Green family)
...
5. `require-brand-in-header` - Logo must say "Velocity"
...
1. **use-styleguide-colors-only** ✅
   - Detects: Any non-brand colors (emerald/teal required for Velocity)
...
5. **consistent-company-info** ✅
   ...
   - Enforces: "Velocity" and "support@velocity.dev"
...
**Colors:**
- [ ] Only uses emerald-*, green-*, teal-*, slate-*
- [ ] NO yellow-*, orange-*, purple-* (except rare utility cases)
...
- [ ] Brand name: "Velocity" (not template)

---

**This checklist is the source of truth for Velocity project setup.**
