...
You are helping a developer align a page or component to Velocity's design system. This is for cases where the functionality works, but the visual style doesn't match the brand.
...
Fix visual/style inconsistencies to match Velocity's design system.
...
## Step 2: Velocity Design System Reference
...
**Checklist:**
- [ ] Colors match Velocity palette (emerald/blue)
...
### After (Velocity style - soft, emerald/blue)
```tsx
...
1. **Commit with clear message**: `git commit -m "Align [PageName] to Velocity design system"`
