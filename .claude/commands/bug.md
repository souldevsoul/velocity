...
You are helping a developer fix a bug in the Velocity application. Follow these systematic steps to ensure a proper fix without cutting corners.
...
6. **Run Quality Checks**
   ...
   **Review any new errors:**
   ...
   - If error is **real** (code violates design system):
     - Fix it now following Velocity design system
