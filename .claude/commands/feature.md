...
You are helping a developer implement a new feature in the Velocity application. Follow these steps to ensure a high-quality implementation.
...
5. **Quality Checks**
   ...
   **Review errors carefully:**
   ...
   - **Real violations?** Fix them following Velocity design system
