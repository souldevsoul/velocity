# Velocity - Claude Code Documentation Index
...
**Purpose:** Align pages/components to Velocity design system
...
2. ✅ `consistent-company-info` - Enforces "Velocity" and "support@velocity.dev"
...
**For:** Velocity (AI Logo Design Platform)
