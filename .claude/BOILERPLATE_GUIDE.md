...
**Tested on:** Velocity (SaaS, Next.js, AI Integration)
...
**Required files (copy from Velocity or create):**
...
1. **`.claude/commands/onboard.md`**
   - Change project name (Velocity → YourProject)
...
**This boilerplate is battle-tested on Velocity.**
